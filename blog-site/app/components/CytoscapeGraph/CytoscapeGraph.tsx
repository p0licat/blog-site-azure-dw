...
import { twitterDataStoreSlice } from "@/lib/redux/slices/TwitterDataStoreSlice/TwitterDataStoreSlice";
...
import {
  ...
  selectLogEvents,
  lastEvent,
} from "@/lib/redux/slices/TwitterDataStoreSlice/selectors";
import {
  queryTweetTextForSingleId,
  fetchGraphDataAsync,
  fetchGraphDataFromTextAsync,
} from "@/lib/redux/slices/TwitterDataStoreSlice/thunks";
...
export const CytoscapeGraph = () => {
  ...
  useEffect(() => {
    ...
    dispatch(twitterDataStoreSlice.actions.clearAllTweetsWithTextCache());
